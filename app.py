...
r"""Flask app for a database of a fictional company's customers, products, stores, and orders.

This file is adapted from the Flask Starter App by osu-cs340-ecampus.
Flask Starter App:
Kochera, George, currym-osu, and Andrew Kamand. “osu-cs340-ecampus/flask-starter-app.” GitHub, 2021,
    Accessed May 22, 2023. https://github.com/osu-cs340-ecampus/flask-starter-app.
"""

__authors__ = "Dania Magana, August Frisk"
